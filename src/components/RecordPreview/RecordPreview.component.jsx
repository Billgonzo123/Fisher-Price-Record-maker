...
export const RecordPreview = ({ notes, maxBeats, song, mousePos }) => {
  ...
  function drawPin(ctx, beat, i, angle) {
    ...
    let space = i < 9 && i > 2 ? (150 / 11) * i - 10 : (150 / 11 / 2) * i + 2; //if its a pin for the first 2 outset patters its ether 2 pins or one  pin per line
  ...
  return (
    <div className="record-preview-container">
      ...
      >
        ...
        <img
          src={require(`${
            mousePos[0] === -1 ? "./FPRP.png" : "./FPRP-Open.png"
          }`)}
          alt="recordPlayer"
